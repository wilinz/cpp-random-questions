...
namespace odb
{
  ...
  struct access::object_traits_impl< ::Person1, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::Person1, id_mysql >::id_type
  access::object_traits_impl< ::Person1, id_mysql >::
  ...
  bool access::object_traits_impl< ::Person1, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::Person1, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::Person1, id_mysql >::persist_statement[] =
  "INSERT INTO `person` "
  "(`id`, "
  "`first`, "
  "`second`, "
  ...
  const char access::object_traits_impl< ::Person1, id_mysql >::find_statement[] =
  "SELECT "
  "`person`.`id`, "
  "`person`.`first`, "
  "`person`.`second`, "
  ...
  const char access::object_traits_impl< ::Person1, id_mysql >::update_statement[] =
  "UPDATE `person` "
  "SET "
  "`first`=?, "
  "`second`=?, "
  ...
  const char access::object_traits_impl< ::Person1, id_mysql >::erase_statement[] =
  "DELETE FROM `person` "
  "WHERE `id`=?";

  const char access::object_traits_impl< ::Person1, id_mysql >::query_statement[] =
  "SELECT "
  "`person`.`id`, "
  "`person`.`first`, "
  "`person`.`second`, "
  ...
  const char access::object_traits_impl< ::Person1, id_mysql >::erase_query_statement[] =
  "DELETE FROM `person`";

  const char access::object_traits_impl< ::Person1, id_mysql >::table_name[] =
  "`person`";
  ...
  access::object_traits_impl< ::Person1, id_mysql >::pointer_type
  access::object_traits_impl< ::Person1, id_mysql >::
  ...
  result< access::object_traits_impl< ::Person1, id_mysql >::object_type >
  access::object_traits_impl< ::Person1, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::Person1, id_mysql >::
