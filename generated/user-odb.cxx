...
namespace odb
{
        ...
        my_bool* t)
  {
    ...
    if (t[2UL])
    {
      i.my_answer_value.capacity (i.my_answer_size);
      grew = true;
    }
        ...
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer_type = MYSQL_TYPE_LONGLONG;
    b[n].is_unsigned = 1;
    b[n].buffer = &i.student_id_value;
    b[n].is_null = &i.student_id_null;
    n++;

    // my_answer
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.my_answer_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.my_answer_value.capacity ());
    b[n].length = &i.my_answer_size;
    b[n].is_null = &i.my_answer_null;
    n++;
    ...
    b[n].buffer_type = MYSQL_TYPE_LONGLONG;
    b[n].is_unsigned = 1;
    b[n].buffer = &i.selected_question_id_value;
    b[n].is_null = &i.selected_question_id_null;
    n++;
  }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
          ...
          mysql::id_ulonglong >::set_image (
        i.student_id_value, is_null, v);
      i.student_id_null = is_null;
    }
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.my_answer_value.capacity ());
      mysql::value_traits<
          ::std::string,
        ...
        is_null,
        v);
      i.my_answer_null = is_null;
      i.my_answer_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.my_answer_value.capacity ());
    }
    ...
    {
      long unsigned int const& v =
        o.selected_question_id;

      bool is_null (false);
      mysql::value_traits<
          long unsigned int,
          mysql::id_ulonglong >::set_image (
        i.selected_question_id_value, is_null, v);
      i.selected_question_id_null = is_null;
    }
        ...
        database* db)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
          ...
          mysql::id_ulonglong >::set_value (
        v,
        i.selected_question_id_value,
        i.selected_question_id_null);
    }
  }
